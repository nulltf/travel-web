<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="com.trip.util.SysConst ,com.trip.vo.*"%>
...
<tbody><tr><td name="name">scofield</td><td name="sex">男</td><td><input type="button" value="移除粉丝" name="action"></td></tr>	
</tbody>
</table>
</div>
</div>
